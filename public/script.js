...
// Alphabetical Index Logic (Sector)
const sectorAlphabetIndex = document.querySelectorAll('#sectorPanel .alphabet-index span');
sectorAlphabetIndex.forEach(span => {
    span.addEventListener('click', () => {
        sectorAlphabetIndex.forEach(s => s.classList.remove('active'));
        span.classList.add('active');

        const letter = span.textContent;
        const items = document.querySelectorAll('#sectorGrid .sector-item');

        items.forEach(item => {
            const text = item.textContent.trim();
            item.style.display = (letter === 'All' || text.startsWith(letter)) ? 'flex' : 'none';
        });
    });
});
            ...
            article.innerHTML = `
                <div class="card-content">
                    <div class="deal-main-info">
                        ...
                        <div class="details-toggle-wrapper" onclick="toggleDetails('moreDetails${deal.id}', this)">
                        ...
                        <div class="expandable-details" id="moreDetails${deal.id}">
                    ...
                    <div class="card-footer centered">
                        <button class="btn-express orange" onclick="openInterestModal()">Express Interest</button>
                    </div>
                </div>
            `;
